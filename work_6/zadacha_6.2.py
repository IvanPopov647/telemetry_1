#2. Напишите программу, в которой пользователю предлагается ввести два
#целочисленных значения. Эти значения определяют границы диапазона, в
#котором отображаются целые числа. Использовать обработку исключений.
